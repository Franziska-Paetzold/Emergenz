...
let texture;
let textures = [dogs_rb, dogs_rg, dogs_bt];
...
function keyPressed()
{
    ...
    else if (key == 'm' || key == 'M' ) // The texture for one facet of the kaleidoscope
    {
        changeTexture();
    }
}
